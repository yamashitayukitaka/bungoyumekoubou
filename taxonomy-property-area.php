...
$archiveUrl = home_url('property/');
$tagArchiveUrl = home_url('property-area/' . $mainQueryTermSlug . '/');
...
if (isset($segments[0]) && $segments[0] === 'property-category' && isset($segments[1])) {
  $lootSlug = $segments[1];
...
} elseif (strpos($lootUrl, 'property-area') !== false) {
...
<?php endif; ?>
  ...
  <?php endif; ?>
    ...
    <?php foreach($propertyTags as $propertyTag):?>
      ...
      <li class = "c-tag__list__item">
        <a href = "<?php echo get_term_link($propertySlug,$tag); ?>" class = "js-tab c-tag__list__link <?php if ($propertySlug === $mainQueryTermSlug):?>u-currentTab<?php endif; ?>">
